...
**MS in AI · NTU Singapore &nbsp;|&nbsp; BComp CS Hons Highest Distinction · NTU Singapore**

[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-ananyakapoor12.github.io-f57c00?style=for-the-badge)](https://ananyakapoor12.github.io)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-ananyakapoor12-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ananyakapoor12/)
[![GitHub](https://img.shields.io/badge/GitHub-ananyakapoor12-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ananyakapoor12)
[![Email](https://img.shields.io/badge/Email-ananya.kapoor.1103@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ananya.kapoor.1103@gmail.com)
...
me = {
    ...
    "highlights": [
        ...
        "Morgan Stanley Insight Program (invite-only)",
    ],
}
```
...
## `me.projects.all().display()`

| Project | Description | Stack |
|---|---|---|
| [**Cancer Drug Target Discovery**](https://github.com/ananyakapoor12/NETwork-Oncology_ML) | ML ranking framework to prioritize drug targets in breast & prostate cancer signaling networks (NTU FYP) | LightGBM · XGBoost · Random Forest · Graph ML |
...
This repo hosts my personal portfolio site at **[ananyakapoor12.github.io](https://ananyakapoor12.github.io)** — built as an interactive JupyterLab notebook simulation entirely in vanilla HTML/CSS/JS.

```
ananyakapoor12.github.io/
└── index.html   ← single-file portfolio (no framework, no build step)
```
...
*Built with* `HTML` · `CSS` · `JavaScript` &nbsp;·&nbsp; *Themed after JupyterLab*
